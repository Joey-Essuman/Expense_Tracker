...
})()(
  {
    ...
    6: [
      function (require, module, exports) {
        ...
        var _Transactions = _interopRequireDefault(
          require("../features/transactions/Transactions")
        );

        var _Budgets = _interopRequireDefault(
          require("../features/budgets/Budgets")
        );
      ...
      {
        "../features/budgets/Budgets": 12,
        "../features/transactions/Transactions": 14,
        react: undefined,
      },
    ],
    7: [
      function (require, module, exports) {
        ...
        var _transactionsSlice = _interopRequireDefault(
          require("../features/transactions/transactionsSlice")
        );

        var _budgetsSlice = _interopRequireDefault(
          require("../features/budgets/budgetsSlice")
        );
      ...
      {
        "../features/budgets/budgetsSlice": 13,
        "../features/transactions/transactionsSlice": 15,
    ...
    8: [
      function (require, module, exports) {
        ...
        function Budget(_ref) {
          ...
          var transactions = (0, _reactRedux.useSelector)(
            _transactionsSlice.selectTransactions
          );

          var handleEdit = function handleEdit(e) {
            e.preventDefault();
            dispatch(
              (0, _budgetsSlice.editBudget)({
          ...
          var getFundsRemainingClassName = function getFundsRemainingClassName(
            amount
          ) {
          ...
          var remainingFunds = Number.parseFloat(
            budget.amount - calculateTotalExpenses()
          ).toFixed(2);
          var fundsRemainingClassName =
            getFundsRemainingClassName(remainingFunds);
          return /*#__PURE__*/ _react["default"].createElement(
            "li",
            {
      ...
      function (require, module, exports) {
        ...
        function TransactionForm(_ref) {
          ...
          var _useState = (0, _react.useState)(
              _transactionsSlice.CATEGORIES[0]
            ),
            _useState2 = _slicedToArray(_useState, 2),
          ...
          var handleSubmit = function handleSubmit(e) {
            e.preventDefault();
            dispatch(
              (0, _transactionsSlice.addTransaction)({
                category: category,
    ...
    12: [
      function (require, module, exports) {
        ...
        var _Budget = _interopRequireDefault(
        ...
        var Transactions = function Transactions() {
          var budgets = (0, _reactRedux.useSelector)(
            _budgetsSlice.selectBudgets
          );
          return /*#__PURE__*/ _react["default"].createElement(
            "ul",
            {
    ...
    14: [
      function (require, module, exports) {
        ...
        var _TransactionForm = _interopRequireDefault(
          require("../../components/TransactionForm")
        );

        var _TransactionList = _interopRequireDefault(
          require("../../components/TransactionList")
        );
        ...
        var Transactions = function Transactions() {
          var transactions = (0, _reactRedux.useSelector)(
            _transactionsSlice.selectFlattenedTransactions
          );
          return /*#__PURE__*/ _react["default"].createElement(
            "div",
            {
            ...
            /*#__PURE__*/ _react["default"].createElement(
              _TransactionList["default"],
              {
                transactions: transactions,
              }
            ),
            /*#__PURE__*/ _react["default"].createElement(
              _TransactionForm["default"],
              null
            )
          );
        };
      ...
      {
        "../../components/TransactionForm": 10,
        "../../components/TransactionList": 11,
        "./transactionsSlice": 15,
        react: undefined,
        "react-redux": undefined,
      },
    ],
    15: [
      function (require, module, exports) {
        ...
        exports["default"] =
          ...
          exports.selectFlattenedTransactions =
        ...
        exports.CATEGORIES = CATEGORIES;
        var initialState = Object.fromEntries(
        ...
        var selectFlattenedTransactions = function selectFlattenedTransactions(
          state
        ) {
        ...
        var transactionsSlice = (0, _toolkit.createSlice)({
          ...
          reducers: {
            ...
            deleteTransaction: function deleteTransaction(state, action) {
              state[action.payload.category].filter(function (obj) {
